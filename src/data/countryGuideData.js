// countryGuideData.js - Gezgin 2.0 Cep Seyahat Rehberi & Vize Bilgisi Bankası
export const COUNTRY_GUIDE_DATA = {
  "TR": {
    "plug": "Type C / F",
    "cur": "TRY (₺)",
    "em": "112",
  ...
  "GE": {
    ...
    "spots": [
      "Tiflis Eski Şehir & Narikala",
      "Batum Bulvarı",
      "Kazbegi Dağı & Gergeti"
    ]
  },
  "GR": {
    "plug": "Type C / F",
  ...
  "XK": {
    ...
    "spots": [
      "Prizren Kalesi & Taş Köprü",
      "Priştine Newborn Anıtı",
      "Rugova Kanyonu"
    ]
  },
  "IT": {
  ...
  "PT": {
    ...
    "spots": [
      "Pena Sarayı (Sintra)",
      "Belém Kulesi (Lizbon)",
      "Ribeira & Dom Luís Köprüsü (Porto)"
    ]
  },
  "BE": {
    "plug": "Type C / E",
    ...
    "spots": [
      "Grand Place Meydanı (Brüksel)",
      "Brugge Orta Çağ Kanalları",
      "Atomium Anıtı"
    ]
  },
  "CZ": {
  ...
  "HU": {
    ...
    "spots": [
      ...
      "Balıkçılar Tabyası & Buda Kalesi",
  ...
  "NO": {
    ...
    "foods": [
      "Somon Füme",
      "Brunost (Kahverengi Peynir)",
      "Kjøttkaker"
    ],
    "spots": [
      "Geiranger Fiyordu",
      "Preikestolen Kayası",
      "Lofoten Adaları & Kuzey Işıkları"
    ]
  },
  "SE": {
    "plug": "Type C / F",
  ...
  "FI": {
    ...
    "spots": [
      ...
      "Suomenlinna Deniz Kalesi",
      "Lapland Kuzey Işıkları & Saunalar"
    ]
  },
  "DK": {
    "plug": "Type C / E / F / K",
    ...
    "foods": [
      "Smørrebrød",
      "Wienerbrød",
      "Danimarka Köftesi (Frikadeller)"
    ],
    "spots": [
      "Nyhavn Renkli Evleri (Kopenhag)",
      "Tivoli Bahçeleri",
  ...
  "JP": {
    ...
    "foods": [
      "Ramen & Udon",
      "Taze Suşi & Sashimi",
      "Kobe Bifteği & Takoyaki"
    ],
    "spots": [
      "Fuji Dağı",
      "Fushimi Inari Bin Torii Kapısı (Kyoto)",
  ...
  "KR": {
    ...
    "vb": "free",
    "vy": "free",
    "vd": "K-ETA ile Vizesiz (90 Gün)",
    "foods": [
      "Kore Barbeküsü (Samgyeopsal)",
      "Kimchi",
      "Bibimbap & Tteokbokki"
    ],
    "spots": [
  ...
  "TH": {
    ...
    "spots": [
      "Büyük Saray & Wat Phra Kaew (Bangkok)",
      "Phi Phi Adaları",
      "Chiang Mai Beyaz Tapınak"
    ]
  },
  "MY": {
    "plug": "Type G (İngiliz)",
    ...
    "spots": [
      "Petronas İkiz Kuleleri (Kuala Lumpur)",
      "Batu Mağaraları",
      "Penang Sokak Sanatı"
    ]
  },
  ...
  "ID": {
    ...
    "spots": [
      "Bali Tapınakları & Pirinç Tarlaları",
  ...
  "VN": {
    ...
    "vb": "voa_evisa",
    "vy": "voa_evisa",
    "vd": "Kolay e-Vize (30 Gün)",
    "foods": [
      "Phở Çorbası",
      "Bánh Mì Sandviç",
      "Vietnam Yumurtalı Kahvesi"
    ],
    "spots": [
      "Ha Long Körfezi Zümrüt Adaları",
      "Hoi An Fenerler Şehri",
      "Hanoi Eski Şehir & Tren Sokağı"
    ]
  },
  "AE": {
    "plug": "Type G (İngiliz)",
    ...
    "vb": "voa_evisa",
    "vy": "free",
    "vd": "e-Vize / Yeşil Pasaporta Vizesiz",
    "foods": [
      "Shawarma",
      "Humus & Falafel",
      "Al Harees"
    ...
    "spots": [
      "Burj Khalifa (Dubai)",
      "Şeyh Zayed Ulu Camii (Abu Dabi)",
      "Dubai Çöl Safarisi & Mall"
    ]
  },
  "QA": {
    "plug": "Type G (İngiliz)",
    ...
    "spots": [
      "Souq Waqif Geleneksel Çarşı",
      "İslam Eserleri Müzesi",
      "Doha Kornişi & İnci Adası"
    ]
  },
  "JO": {
    "plug": "Type C / D / F / G / J",
    ...
    "spots": [
      ...
      "Wadi Rum Kızıl Çölü",
      "Ölü Deniz (Lut Gölü Batmayan Su)"
    ]
  },
  "EG": {
    "plug": "Type C / F",
    ...
    "vb": "voa_evisa",
    "vy": "free",
    "vd": "Kapıda Vize (25$) / Yeşil Vizesiz",
    "foods": [
      "Koshari",
      "Ful Medames",
      "Taameya (Mısır Falafeli)"
    ],
    "spots": [
      "Gize Piramitleri & Sfenks (Kahire)",
      "Luksor & Krallar Vadisi",
      "Şarm El-Şeyh Kızıldeniz Mercanları"
    ]
  },
  "MA": {
    "plug": "Type C / E",
  ...
  "US": {
    ...
    "spots": [
      "Özgürlük Heykeli & Times Square (NY)",
      "Büyük Kanyon (Grand Canyon)",
      "Golden Gate Köprüsü (SF)"
    ]
  },
  "CA": {
    "plug": "Type A / B (120V)",
  ...
  "BR": {
    ...
    "foods": [
      "Feijoada",
      "Pão de Queijo",
      "Açai Kasesi & Churrasco"
    ],
    "spots": [
      "Kurtarıcı İsa Heykeli & Copacabana (Rio)",
      "Iguazú Şelaleleri",
  ...
  "MX": {
    ...
    "vb": "voa_evisa",
    "vy": "free",
    "vd": "Online Kolay SAE Vizesi (30 Gün)",
    "foods": [
      "Tacos al Pastor",
      "Guacamole & Nachos",
      "Chiles en Nogada"
