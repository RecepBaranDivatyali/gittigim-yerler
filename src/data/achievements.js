...
export const ACHIEVEMENTS = [
  ...
  { id: 'star_collector', title: 'Star Alliance Koleksiyoneri', desc: 'Star Alliance üyesi en az 3 farklı havayoluyla uç', icon: '🌟', category: 'aviation', check: s => (s.flownAirlines || []).filter(id => ['thy', 'lufthansa', 'united', 'singapore', 'swiss', 'austrian', 'ana', 'aircanada', 'tap_portugal', 'aegean', 'lot_polish', 'eva_air', 'air_china', 'thai_airways', 'copa', 'brussels'].includes(id)).length >= 3 },
  { id: 'skyteam_rider', title: 'SkyTeam Yolcusu', desc: 'SkyTeam üyesi bir havayoluyla uç', icon: '🌐', category: 'aviation', check: s => (s.flownAirlines || []).some(id => ['airfrance', 'klm', 'delta', 'koreanair', 'saudia', 'virgin', 'aeromexico', 'ita', 'vietnam_airlines', 'garuda_indonesia', 'air_europa', 'tarom'].includes(id)) },
  { id: 'oneworld_flyer', title: 'oneworld Gezgini', desc: 'oneworld üyesi bir havayoluyla uç', icon: '🦅', category: 'aviation', check: s => (s.flownAirlines || []).some(id => ['british', 'qatar', 'american', 'cathay', 'finnair', 'iberia', 'jal', 'qantas', 'royal_jordanian', 'malaysia', 'royal_air_maroc', 'alaska_airlines'].includes(id)) },
